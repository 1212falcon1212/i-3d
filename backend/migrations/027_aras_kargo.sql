...
INSERT INTO `settings` (`key`, `value`, `group`, `updated_at`) VALUES
    ...
    -- Kimlik bilgileri panelden girilir (Ayarlar → Kargo); migration'da tutulmaz.
    ('aras.username',          '',               'aras_kargo', NOW()),
    ('aras.password',          '',               'aras_kargo', NOW()),
    ('aras.customer_code',     '',               'aras_kargo', NOW()),
